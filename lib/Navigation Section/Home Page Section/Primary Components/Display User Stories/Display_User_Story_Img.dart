...
class _PhotoDisplayScreenState extends State<PhotoDisplayScreen> {
  ...
  void initState() {
    ...
    getLocalPostBody();
    widget.story.storyMediaType == 'Image' ? getImage() : getVideo();
  }
  ...
  Future<void> getVideo() async {
    _controller = VideoPlayerController.network(widget.story.storyMediaUrl)
      ..initialize().then(
        (_) {
          setState(() {});
      ...
      children: [
        ...
        Positioned.fill(
          child: Container(
            ...
            child: widget.story.storyMediaType == 'Image'
                ? CachedNetworkImage(
